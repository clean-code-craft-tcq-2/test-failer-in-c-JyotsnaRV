...
int main() {
    ...
    farenheitReading = 350.6;
//    farenheitReading = 303.6; /* for negative test case */
    alertInCelcius(farenheitReading);
    assert(alertFailureCount == 1);
//    assert((303.6) == celciusTempReading); /* for negative test case */
    assert((350.6) == celciusTempReading);
    alertFailureCount = 0;
